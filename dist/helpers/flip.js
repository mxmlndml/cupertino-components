const getHeight = (clientRect) => clientRect.bottom - clientRect.top;
const getWidth = (clientRect) => clientRect.right - clientRect.left;
const getTransformations = (oldElement, newElement) => {
...
const flip = (firstElement, lastElement, parameters = defaultConfig) => {
    ...
    const css = `translate3d(${translateX}px, ${translateY}px, 0) scale3d(${scaleX}, ${scaleY}, 1)`;
